...
module.exports = (app) => {
  ...
  app.post('/matches/getByGameId', passport.authenticate('jwt', {session: false}), controlles.matches.getByGameId)
  app.post('/matches/getByCompetitionId', passport.authenticate('jwt', {session: false}), controlles.matches.getByCompetitionId)
  app.post('/matches/getById',passport.authenticate('jwt', {session: false}), controllers.matches.getMatchesById)
